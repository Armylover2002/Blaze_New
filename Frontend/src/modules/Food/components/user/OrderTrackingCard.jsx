          ...
          <div className="flex items-center gap-4 relative z-10 w-full">
            ...
            <div className="flex-1 min-w-0 pr-4">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <ChevronRight className={`w-3.5 h-3.5 ${isQuickOrder ? 'text-blue-500' : 'text-[#FF0000]'} shrink-0 group-hover:translate-x-1 transition-transform`} />
              </div>
            </div>

            <div className={`bg-gradient-to-br ${isQuickOrder ? 'from-blue-500 to-blue-600 shadow-blue-500/20 border-blue-200' : 'from-[#FF0000] to-[#C83C00] shadow-red-500/20 border-red-200'} shadow-lg rounded-xl px-4 py-2 shrink-0 flex flex-col items-center justify-center border`}>
