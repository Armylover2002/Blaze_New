                            ...
                            <div className="p-4 border-b border-slate-50 flex flex-col gap-3 bg-slate-50/30">
                                ...
                                <div className="flex items-center justify-between gap-2 flex-wrap">
                                    ...
                                    <Button
                                        ...
                                        className="rounded-xl px-4 py-2 text-[10px] font-bold shadow-lg shadow-red-500/20"
                                    >
                        ...
                        >
                            ...
                            <div className="p-6 bg-slate-50 border-t border-slate-100 flex gap-3">
                                ...
                                <Button
                                    ...
                                    className="flex-1 py-4 text-xs font-bold rounded-2xl shadow-xl shadow-red-500/20"
                                >
                                    SAVE CHANGES
                                </Button>
                            </div>
