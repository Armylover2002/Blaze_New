                ...
                <AnimatePresence mode="popLayout">
                  {paginatedDeliveries.map((dlv, idx) => (
                    <motion.div
                      ...
                      className="group relative bg-white rounded-lg border border-slate-100 p-2 sm:p-1 hover:shadow-2xl hover:shadow-red-500/5 hover:border-red-500/20 transition-all duration-500 min-w-0">
                      <div className="flex flex-col lg:flex-row items-stretch gap-3 sm:gap-1">
                        ...
                        <div className="lg:w-16 flex items-center justify-center p-2 sm:p-3 shrink-0">
                          <button className="h-10 w-10 lg:h-full lg:w-full bg-red-500 group-hover:bg-red-600 rounded-lg lg:rounded-r-lg lg:rounded-l-none flex items-center justify-center text-white transition-all duration-500 shadow-xl shadow-red-500/20 hover:shadow-red-500/30">
