...
export const mapPorterOrderForUser = (doc) => {
    ...
    return {
        ...
        dispatch: o.dispatch ? {
            ...
            assignedAt: o.dispatch.assignedAt || null,
            acceptedAt: o.dispatch.acceptedAt || null,
            scheduledDispatchedAt: o.dispatch.scheduledDispatchedAt || null,
            manuallyAssigned: o.dispatch.manuallyAssigned || false,
        } : undefined,
        deliveryState: {
        ...
        schedule: o.schedule ? {
            status: o.schedule.status || null,
            timezone: o.schedule.timezone || null,
            activatedAt: o.schedule.activatedAt || null,
            dispatchStartedAt: o.schedule.dispatchStartedAt || o.schedule.activatedAt || null,
            scheduledUpdatedAt: o.schedule.scheduledUpdatedAt || null,
            lastUpdatedAt: o.schedule.lastUpdatedAt || null,
            bullJobId: o.schedule.bullJobId || null,
            reminderJobId: o.schedule.reminderJobId || null,
            reminderScheduledAt: o.schedule.reminderScheduledAt || null,
            reminderSentAt: o.schedule.reminderSentAt || null,
        } : undefined,
        rating: o.rating,
